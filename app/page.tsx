...
export default function HomePage() {
  return <main className="launch-site launch-glass-site">
    ...
    <section className="launch-hero glass-hero"><div className="launch-hero-copy"><p className="launch-kicker">THE ONLINE ORDERING SYSTEM FOR PRINT SHOPS</p><h1>Turn custom apparel requests into paid, production-ready orders.</h1><p>PrintFlow connects your storefront, supplier catalog, pricing, artwork, payment, and blank purchasing so customers can order confidently and your team can produce without chasing details.</p><div className="launch-hero-actions"><Link className="launch-primary" href="/signup?plan=growth">Start your 14-day trial</Link><a className="launch-secondary" href="#workflow">See the workflow</a></div><div className="launch-mini-proof"><span>Live supplier costs</span><span>500 MB artwork</span><span>Front + back mockups</span><span>Stripe or Square</span></div></div>
