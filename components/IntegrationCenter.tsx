...
const definitions: Definition[] = [
  ...
  { provider: "google-drive", name: "Google Drive Delivery", category: "Files", initials: "GD", description: "Production-file delivery and job-folder automation.", capability: "Planned file delivery and automatic job-folder organization.", status: "roadmap" },
  { provider: "shopify", name: "Shopify Commerce", category: "Commerce", initials: "SH", description: "Product, customer, and order synchronization.", capability: "Planned product, customer, and order synchronization.", status: "roadmap" },
  { provider: "squarespace", name: "Squarespace Commerce", category: "Commerce", initials: "SC", description: "Commerce order and catalog synchronization.", capability: "Planned commerce order and catalog synchronization.", status: "roadmap" },
  { provider: "sanmar", name: "SanMar", category: "Suppliers", initials: "SM", description: "Catalog and wholesale order connection.", capability: "Planned catalog and wholesale-order connection.", status: "roadmap" }
];
