...
type Definition = { provider: string; name: string; category: string; initials: string; logo: string; description: string; capability: string; fields?: Field[]; actionHref?: string; status: "live" | "roadmap" };

const definitions: Definition[] = [
  { provider: "stripe", name: "Stripe Payments", category: "Payments", initials: "ST", logo: "/integrations/stripe.png", description: "Native Stripe Checkout, live payment status, and automatic order updates.", capability: "Creates secure hosted checkout and keeps paid-order status synchronized.", status: "live", fields: [{ key: "secretKey", label: "Stripe secret key", type: "password", placeholder: "sk_live_…", help: "Use a live key for production or a test key while validating your workflow." }] },
